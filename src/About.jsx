  ...
  return (
    <div className='about'>
      ...
      <div className='im'>
        ...
        <div className='im1'>  <img src={rect2} alt="" className='rect1' />
          <div className='button1'>
                <ul className='unorder'>
                  <li > <b>NEW GODDIES</b> <img src={vector} alt=""  className='vect'/><p className="hidden">shop</p> </li>
                </ul>
        </div></div>
      
        <div className='im2'><img src={rect1} alt="" className='rect2'/>
           <div className='button2'>
                   <ul className='unorder'>
                  <li> <b>PANTRY</b><img src={vector} alt=""  className='vect'/><p className="hidden">shop</p> </li>
                </ul>
        </div>
        </div>
       <div className='im3'> <img src={rect3} alt="" className='rect3'/>
         <div className='button3'>
                 <ul className='unorder'>
                  <li><b>BATH</b> <img src={vector} alt="" className='vect'/ ><p className="hidden">shop</p></li>
                </ul>
        </div>
       </div>
      </div>
      ...
      <div className='content'>
        ...
        <div className="para">
            <div className="para1">
                <p> Everything we do is designed to rebuild <br />
